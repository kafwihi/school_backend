...
public class StudentSubjectOperations implements Serializable {
...
public StudentSubjectOperations(){
    super();
}
    public StudentSubjectOperations(String regno,Boolean english,Boolean kiswahili, Boolean mathematics, Boolean chemistry
